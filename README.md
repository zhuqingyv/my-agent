...
MA is built for developers who switch between local models and remote APIs, work inside real repos, and want a terminal agent that is pleasant to configure instead of painful to babysit.
...
Additional internal commands still exist for debugging and power users, but they are intentionally hidden from slash suggestions until their UX is good enough.
...
Create a portable bundle locally:
...
The release workflow builds macOS, Linux, and Windows portable bundles and attaches checksums.
